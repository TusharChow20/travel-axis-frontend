...
interface TourFilterProps {
  ...
  onMobileClose?: () => void; // ✅ auto close on mobile
}
...
const FilterSection = ({
  ...
  return (
    <div className="border border-border rounded-xl overflow-hidden">
      ...
      {/* ✅ Collapsible content */}
      {isOpen && (
        <div className="px-4 pb-4 pt-2 bg-card space-y-1">{children}</div>
      )}
    </div>
  );
};
...
export const TourFilter = ({
  ...
  // ✅ Handle filter change + auto close mobile sidebar
      ...
      <FilterSection title="Price Range" defaultOpen={true}>
        <div className="pt-2 pb-1">
          <div className="flex items-center justify-between mb-4">
            <span className="text-xs font-medium text-foreground bg-primary/10 text-primary px-2 py-1 rounded-md">
